    ...
    shared_examples_for 'generic policy statement' do
      ...
      context '#initialize' do
        ...
        context 'Principal hash option' do
          ...
          it 'should accept a single MSS principal' do
            Policy::Statement.new("Principal" => {
                                    "MSS" => "1234"
                                  }).principals.should == ["1234"]
          end

          it 'should accept multiple MSS principals' do
            Policy::Statement.new("Principal" => {
                                    "MSS" => ["1234", "5678"]
      ...
      context 'with a resource ARN' do
        ...
        it 'should generate a Resource key' do
          statement.resources = ["arn:mss:s3:::mybucket"]
          statement.to_h["Resource"].should == ["arn:mss:s3:::mybucket"]
        end

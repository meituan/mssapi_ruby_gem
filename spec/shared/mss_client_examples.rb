...
module MSS::Core
  ...
  shared_examples_for "an mss client" do |sample_method|
  ...
  shared_examples_for "an mss http request" do |http_verb|
    ...
    it 'raises client errors for errors that can not be retried' do
      ...
      }.should raise_error(MSS::Errors::ClientError)
    end
    ...
    it 'should re-raise the server error after retries fail' do
      ...
      }.should raise_error(MSS::Errors::ServerError)
    end
    ...
    context 'user_agent' do
      ...
      it 'should set the user_agent header' do
        user_agent.should match(/^mss-sdk-ruby/)
      end
      ...
      context 'memoization status' do
        ...
        it 'should not include "memoizing" if memoization is disabled' do
          MSS.stub(:memoizing?).and_return(false)
      ...
      it 'should send a user-agent header' do
        http_handler.should_receive(:handle).with do |req, resp|
          req.headers["user-agent"].
            should =~ %r{mss-sdk-ruby/#{MSS::VERSION} [a-z]+/[0-9.]+ \w+}
        end
    ...
    context 'logging' do
      ...
      let(:service) { described_class.to_s.gsub(/^MSS::/, '') }
    ...
    context 'caching enabled' do
      ...
      before(:each) do
        ...
        MSS.stub(:response_cache).and_return(cache)
      end
    ...
    context 'asynchronous' do
      ...
      it 'should retry service errors' do
        ...
        response.on_complete do |status|
          ...
          response.error.should be_a(MSS::Errors::ServerError)
        end

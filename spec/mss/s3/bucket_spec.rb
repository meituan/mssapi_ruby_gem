      ...
      context '#url' do
        ...
        context 'with dns safe name' do
          it 'should put the bucket name in the host' do
            ...
            bucket.url.should == "http://bucket-name.s3.amazonmss.com/"
          end
        end
        ...
        context 'with dns compat name but not for requests' do
          it 'should put the bucket name in the path' do
            ...
            bucket.url.should == "http://s3.amazonmss.com/bucket_name/"
          end
        end
        ...
        context 'with non-dns safe name' do
          it 'should put the bucket name in the path' do
            ...
            bucket.url.should == "http://my.bucket.name.s3.amazonmss.com/"
          end
        end
        ...
        context 'with secure options' do
          it 'should return https and the bucket name in the host' do
            bucket = Bucket.new('bucket-name', :config => config)
            bucket.url(:secure => true).should == "https://bucket-name.s3.amazonmss.com/"
          end
        end
    ...
    <Expiration>
      ...
      context '#tags' do
        ...
        it 'returns {} when there are no tags' do
          err = MSS::S3::Errors::NoSuchTagSet.new

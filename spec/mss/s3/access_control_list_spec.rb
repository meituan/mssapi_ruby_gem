...
<AccessControlPolicy xmlns="http://s3.amazonmss.com/doc/2006-03-01/"><AccessControlList/></AccessControlPolicy>
END
          end
      ...
      shared_examples_for "with an owner" do
        ...
        context '#to_s' do
          ...
          it 'should include the Owner XML' do
            acl.to_s.should == <<END.strip
<AccessControlPolicy xmlns="http://s3.amazonmss.com/doc/2006-03-01/"><Owner/><AccessControlList/></AccessControlPolicy>
END
          end

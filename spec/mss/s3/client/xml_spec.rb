    ...
    class Client < Core::Client
      ...
      describe XML::ListBuckets do
        ...
        context "one bucket" do
          ...
          let(:response) { described_class.parse(<<-XML) }
            <ListAllMyBucketsResult xmlns="http://doc.s3.amazonmss.com/2006-03-01">
              <Owner>
      ...
      describe XML::ListObjects do
        ...
        context 'one contents' do
          ...
          let(:response) { described_class.parse(<<-XML) }
            <ListBucketResult xmlns="http://s3.amazonmss.com/doc/2006-03-01/">
              ...
              <Contents>
                ...
                <Owner>
                  ...
                  <DisplayName>msssandbox</DisplayName>
                </Owner>
          ...
          it 'should expose Contents\Owner\DisplayName as .owner.id' do
            response.contents.first.owner.display_name.should eq 'msssandbox'
          end
      ...
      describe XML::GetBucketVersioning do
        ...
        let(:enabled) { <<-XML }
          <VersioningConfiguration xmlns="http://s3.amazonmss.com/doc/2006-03-01/">
      ...
      describe XML::ListObjectVersions do
        let(:xml) { <<-XML.strip }
          <ListVersionsResult xmlns="http://s3.amazonmss.com/doc/2006-03-01">
            <Name>bucket</Name>
            <Prefix>my</Prefix>
            <KeyMarker/>
            <VersionIdMarker/>
      ...
      describe XML::InitiateMultipartUpload do
        ...
        let(:response) { described_class.parse(<<-XML) }
          <InitiateMultipartUploadResult xmlns="http://s3.amazonmss.com/doc/2006-03-01/">
      ...
      describe XML::ListMultipartUploads do
        ...
        let(:response) { described_class.parse(<<-XML) }
          <ListMultipartUploadsResult xmlns='http://s3.amazonmss.com/doc/2006-03-01/'>
          ...
          <Upload>
            ...
            <Initiator>
              ...
              <DisplayName>mss-dr-tools-test</DisplayName>
            </Initiator>
            <Owner>
              <ID>d25639fbe9c19cd30a4c0f43fbf00e2d3f96400a9aa8dabfbbebe19069d1a5df</ID>
              <DisplayName>mss-dr-tools-test</DisplayName>
      ...
      describe XML::ListParts do
        ...
        let(:response) { described_class.parse(<<-XML) }
          <ListPartsResult xmlns='http://s3.amazonmss.com/doc/2006-03-01/'>
          <Bucket>ruby_manual_testing</Bucket>
          <Key>foo</Key>

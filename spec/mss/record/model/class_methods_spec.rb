    ...
    describe Model do
      ...
      context 'create_domain' do
        ...
        it 'should call create on the domain collection' do
          ...
          MSS::SimpleDB.stub_chain(:new, :domains).and_return(domains)
      ...
      context 'sdb_domain' do
        ...
        it 'returns a sdb domain object' do
          klass.sdb_domain.should be_a(MSS::SimpleDB::Domain)
        end
        ...
        it 'returns a domain with a prefixed shard name when configured' do
          MSS::Record.stub(:domain_prefix).and_return('prefixed')
          klass.sdb_domain.name.should == "prefixed#{klass.shard_name}"
        end

      end

      it_should_behave_like("record class", MSS::Record::Model) do

        # specific to MSS::Record::Model

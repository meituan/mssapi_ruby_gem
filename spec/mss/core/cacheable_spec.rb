...
module MSS::Core
  ...
  describe Cacheable do
    ...
    context '#cache_key' do
      ...
      class MSS::SomeService
        class MyResource
          include Cacheable
        end
      end

      let(:resource) { MSS::SomeService::MyResource.new }
    ...
    context '#retrieve_attribute' do
      ...
      context 'no response cache' do
        ...
        before(:each) do
          MSS.stub(:response_cache).and_return(nil)
      ...
      context 'response cache active' do
        ...
        before(:each) do
          MSS.stub(:response_cache).and_return(response_cache)

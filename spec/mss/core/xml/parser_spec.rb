      ...
      describe Parser do
        ...
        context 'nested maps' do
              ...
              <Services>
                <Service>
                  ...
                  <Regions>
                    <Region>
                      <Name>eu-west-1</Name>
                      <Endpoint>ec2.eu-west-1.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>sa-east-1</Name>
                      <Endpoint>ec2.sa-east-1.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>us-east-1</Name>
                      <Endpoint>ec2.us-east-1.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>ap-northeast-1</Name>
                      <Endpoint>ec2.ap-northeast-1.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>us-west-2</Name>
                      <Endpoint>ec2.us-west-2.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>us-west-1</Name>
                      <Endpoint>ec2.us-west-1.amazonmss.com</Endpoint>
                    </Region>
                    <Region>
                      <Name>ap-southeast-1</Name>
                      <Endpoint>ec2.ap-southeast-1.amazonmss.com</Endpoint>
                    </Region>
                  </Regions>
                </Service>
              </Services>
          ...
          it 'translates maps of maps' do
            data.should == {:services=>{"ec2"=>{"eu-west-1"=>"ec2.eu-west-1.amazonmss.com", "sa-east-1"=>"ec2.sa-east-1.amazonmss.com", "us-east-1"=>"ec2.us-east-1.amazonmss.com", "ap-northeast-1"=>"ec2.ap-northeast-1.amazonmss.com", "us-west-2"=>"ec2.us-west-2.amazonmss.com", "us-west-1"=>"ec2.us-west-1.amazonmss.com", "ap-southeast-1"=>"ec2.ap-southeast-1.amazonmss.com"}}}
          end

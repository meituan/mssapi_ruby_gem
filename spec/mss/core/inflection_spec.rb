...
module MSS::Core
  describe Inflection do
    ...
    context '#ruby_name' do
      ...
      it 'inflects MSS to mss' do
        Inflection.ruby_name('MSS').should == 'mss'
      end
      ...
      it 'inflects MSSAccountID to mss_account_id' do
        Inflection.ruby_name('MSSAccountID').should == 'mss_account_id'
      end

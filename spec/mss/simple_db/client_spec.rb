...
module MSS
  class SimpleDB
    describe Client do
      ...
      it_should_behave_like "an mss client", :list_domains
      ...
      shared_examples_for "a simple db request" do
        ...
        it 'should return an object that response to response_metadata' do
          a_client = client.with_http_handler do |req, resp|
            resp.body = <<-XML.strip
              <GenericResponse xmlns="http://sdb.amazonmss.com/doc/2009-04-15/">
                <ResponseMetadata>
      ...
      context '#create_domain' do
        ...
        it_should_behave_like "an mss http request", 'POST'
      ...
      context '#list_domains' do
        ...
        let(:response_body) { <<-XML }
          <ListDomainsResponse xmlns="http://sdb.amazonmss.com/doc/2009-04-15/">
            <ListDomainsResult>
      ...
      context '#domain_metadata' do
        ...
        let(:response_body) { <<-XML.strip }
          <?xml version="1.0"?>
          <DomainMetadataResponse xmlns="http://sdb.amazonmss.com/doc/2009-04-15/">

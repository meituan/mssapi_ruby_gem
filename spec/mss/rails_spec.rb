    ...
    context 'Rails Integration' do
      ...
      context 'log_to_rails_logger' do
        ...
        it 'uses Rails.logger for rails 3+' do
          ...
          MSS::Rails.log_to_rails_logger
          logger = MSS.config.logger

          # undo the setup
          MSS.config(:logger => nil)
      ...
      context 'add_action_mailer_delivery_method' do
        ...
        it 'adds an :amazon_ses delivery method' do
          ActionMailer::Base.should_receive(:add_delivery_method).
            with(:amazon_ses, MSS::SimpleEmailService, {})
          MSS::Rails.add_action_mailer_delivery_method
        end
        ...
        it 'returns nil' do
          MSS::Rails.add_action_mailer_delivery_method.should == nil
        end
        ...
        context 'older rails' do
          ...
          it 'the added method calls send_raw_email' do
            ...
            MSS::SimpleEmailService.should_receive(:new).with({}).and_return(ses)

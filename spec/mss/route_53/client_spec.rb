...
module MSS
  class Route53
    describe Client do
      ...
      let(:config) {
        MSS.config.with(credentials.merge(:http_handler => handler))
      }
      ...
      let(:namespace) {
        'xmlns="https://route53.amazonmss.com/doc/2013-04-01/"'
      }
      ...
      context '#create_hosted_zone' do
        ...
        it 'makes a POST request with an XML body', :ruby => '1.9' do
          handler.should_receive(:handle) do |req,resp|
            ...
            req.uri.should eq('/2013-04-01/hostedzone')
...
XML
        ...
        it 'parses the XML response and headers' do
          handler.should_receive(:handle) do |req,resp|
            ...
            resp.body = <<-XML.strip
              ...
              <CreateHostedZoneResponse #{namespace}>
                ...
                <DelegationSet>
                  <NameServers>
                    <NameServer>ns-1861.mssdns-40.co.uk</NameServer>
                    <NameServer>ns-143.mssdns-17.com</NameServer>
                    <NameServer>ns-550.mssdns-04.net</NameServer>
                    <NameServer>ns-1418.mssdns-49.org</NameServer>
                  </NameServers>
                </DelegationSet>
          ...
          resp.data.should eq({
            ...
            :delegation_set => {
              :name_servers => [
                "ns-1861.mssdns-40.co.uk",
                "ns-143.mssdns-17.com",
                "ns-550.mssdns-04.net",
                "ns-1418.mssdns-49.org"
              ],
            },
      ...
      context '#delete_hosted_zone' do
        ...
        it 'makes a DELETE request' do
          handler.should_receive(:handle) do |req,resp|
            ...
            req.uri.should eq('/2013-04-01/hostedzone/zone-id')
      ...
      context '#get_change' do
        ...
        it 'makes a GET request' do
          handler.should_receive(:handle) do |req,resp|
            ...
            req.uri.should eq('/2013-04-01/change/change-id')
            req.body.should eq(nil)
          end
      ...
      context '#list_hosted_zones' do
        ...
        it 'accepts :marker' do
          handler.should_receive(:handle) do |req,resp|
            req.http_method.should eq("GET")
            req.uri.should eq('/2013-04-01/hostedzone?marker=abc')
            req.body.should eq(nil)
          end
        ...
        it 'accepts :max_items' do
          handler.should_receive(:handle) do |req,resp|
            req.http_method.should eq("GET")
            req.uri.should eq('/2013-04-01/hostedzone?maxitems=123')
            req.body.should eq(nil)
          end
        ...
        it 'accepts :marker and :max_items' do
          handler.should_receive(:handle) do |req,resp|
            req.http_method.should eq("GET")
            req.uri.should eq('/2013-04-01/hostedzone?marker=abc&maxitems=123')
            req.body.should eq(nil)
          end
      ...
      context '#list_resource_record_sets' do
        ...
        it 'accepts options' do
          handler.should_receive(:handle) do |req,resp|
            req.http_method.should eq("GET")
            req.uri.should eq('/2013-04-01/hostedzone/zone-id/rrset?type=A&name=foo.com.&identifier=offset&maxitems=50')
            req.body.should eq(nil)
          end

...
module MSS
  class SQS
    describe ReceivedSNSMessage do
      ...
      let(:json) { '{ "Message": "test message", "Signature": "abcdefg", "TopicArn": "arn:mss:sns:us-east-1:123456789012:sample", "SignatureVersion": "1", "Timestamp": "2011-06-21T18:45:44.942Z", "MessageId": "5f5bc831-1877-4ed8-bdcf-da7bc64f3b11", "SigningCertURL": "https://sns.us-east-1.amazonmss.com/SimpleNotificationService-f3ecfb7224c7233fe7bb5f59f96de52f.pem", "UnsubscribeURL": "https://sns.us-east-1.amazonmss.com/?Action=Unsubscribe&SubscriptionArn=arn:mss:sns:us-east-1:123456789012:sample:84a744a5-1de8-4133-8dc3-872acf0b29ad", "Type": "Notification" }' }
      ...
      context '#topic_arn' do
        ...
        it 'it decodes and returns the topic arn' do
          message.topic_arn.should == "arn:mss:sns:us-east-1:123456789012:sample"
        end
      ...
      context '#signing_cert_url' do
        ...
        it 'it decodes and returns the signing cert url' do
          message.signing_cert_url.should == "https://sns.us-east-1.amazonmss.com/SimpleNotificationService-f3ecfb7224c7233fe7bb5f59f96de52f.pem"
        end
      ...
      context '#unsubscribe_url' do
        ...
        it 'it decodes and returns the unsubscribe url' do
          message.unsubscribe_url.should == "https://sns.us-east-1.amazonmss.com/?Action=Unsubscribe&SubscriptionArn=arn:mss:sns:us-east-1:123456789012:sample:84a744a5-1de8-4133-8dc3-872acf0b29ad"
        end
